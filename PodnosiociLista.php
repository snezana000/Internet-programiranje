...
// koristimo klasu za poziv procedure za konekciju
    ...
    {	
		...
		$PodnosilacViewObject = new DBPodnosilac($KonekcijaObject,"podnosilac");
		if (isset($_GET['filtriraj']))
			{
				// prikaz filtriranih podataka primenom pogleda nad kojim je dodat filter
				$filter=$_GET['filter'];
				$PodnosilacViewObject->DajSvePodatkeOPodnosilacima($filter);
...
<?php include 'delovi/desnoPodnosiociLista.php';?>
</td>
