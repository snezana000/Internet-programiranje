...
if ($PodnosilacViewObject->BrojZapisa==0)
	...
	echo "УКУПАН БРОЈ ЗАПИСА:".$PodnosilacViewObject->BrojZapisa;
		...
		$StatusPasosa=$PodnosilacViewObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($PodnosilacViewObject->Kolekcija, $RBZapisa, 3);
		...
		echo "</td>";
		echo "<td>";
		echo "<form ACTION=\"PodnosilacIzmeniForm.php\" METHOD=\"POST\">";
		echo "<input type=\"hidden\" name=\"JMBG\" value=\"$JMBG\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\"><input TYPE=\"submit\" name=\"izmeniPodnosioca\" value=\"ИЗМЕНИ\" /></font></b>";
		echo "</form>";
		echo "</td>";
		echo "<td>";
		echo "<form ACTION=\"PodnosilacObrisi.php\" METHOD=\"POST\">";
		echo "<input type=\"hidden\" name=\"JMBG\" value=\"$JMBG\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\"><input TYPE=\"submit\" name=\"obrisiPodnosilaca\" value=\"ОБРИСИ\"  onclick=\"return confirm('Да ли сте сигурни да желите да обришете запис?')\"/></font></b>";
		echo "</form>";
		echo "</td>";
		echo "</tr>";
