...
<td align="center">
<b><font face="Trebuchet MS" color="black" size="3px">УНОС НОВОГ ПОДНОСИОЦА</b></br>
</td>
<td style="width:3%;">
</td>
</tr>
...
<form name="FormaZaUnosPodnosioca" action="podnosilacsnimiSP.php" METHOD="POST" enctype="multipart/form-data" >
...
<input name="JMBG" type="text" size="50" placeholder="Унесите ЈМБГ"  />
</td>
</tr>
...
<tr>
<td align="right" valign="bottom">
<b><font face="Trebuchet MS" color="black" size="2px">Пасош&nbsp;&nbsp;</font><br/></b>
</td>
<td align="left" valign="bottom">
<select name="sifraPasosa" required TABINDEX=7>		
	...
	{					
		for ($brojacPasosa = 0; $brojacPasosa < $UkupanBrojZapisa; $brojacPasosa++) 
			{
				$oznakaPasosa =$PasosObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisa, $brojacPasosa, 0);				
				$nazivPasosa=$PasosObject->DajVrednostPoRednomBrojuZapisaPoRBPolja ($KolekcijaZapisa, $brojacPasosa, 1);				
				echo "<option value=\"$oznakaPasosa\">$nazivPasosa</option>";						
			} //for
